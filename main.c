...
int match[20];
int x=0,y=0;
GLfloat cube[8][3]={ {15,15,-15},{18,18,18},{-15,15,-15},{-18,18,18},{-15,-15,-15},{-18,-18,18},{15,-15,-15},{18,-18,18}};
...
char texta[]={"MEMORY BLOCKS GAME USING OPENGL"};
char text2[]={"PRESS SPACE TO START"};
char text1[]={"GRAPHICAL IMPLEMENTATION OF A MINI PROJECT ON"};
char textb[]={"SUBMITTED BY"};
char textc[]={"UNDER THE GUIDANCE OF"};
char textd[]={"MRS.JAISHMA KUMARI"};
char texte[]={""};
char textf[]={""};
char texth[]={"VAGISHA (4SO19CS170)"};
char textg[]={"TG CHANDRAKALA(4SO19CS170)"};
char texti[]={"MRS.SHREEDEVI SARALAYA"};
char textj[]={"DEPARTMENT OF CSE ,SJEC, MANGALURU"};
char textk[]={"ASSISTANT PROFESSOR"};
char textko[]={"HOD"};
void initialize(){
 ...
 status=1;
  ...
  void disp()     //routine to rotate cube
   ...
   int main(int argc,char **argv)  //main routine
	...
	glutCreateWindow("FIND IT BLOCKS GAME");
